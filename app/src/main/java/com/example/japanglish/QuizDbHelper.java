...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable(){
        ...
        addQuestion(q5);
        Question q6 = new Question("C is Correct", "A", "B", "C", 3 );
        addQuestion(q6);
    }
    private void addQuestion(Question question){
        ...
        cv.put(QuestionsTable.COLUMN_QUESTION, question.getOption2());
        cv.put(QuestionsTable.COLUMN_QUESTION, question.getOption3());
